...
public class SearchRequestBuilder {
    ...
    private SearchAdsVariables buildVariables(UserSession s) {
    ...
    public GraphQLRequest buildRequest(UserSession userSession) {
        return new GraphQLRequest(QUERY, buildVariables(userSession).toMap());
    }
}
