...
public class CarFlowHandler {
    ...
    public CarFlowHandler(CarOptionsService carOptionsService, KeyboardFactory keyboard,
                          MessageService messages, SessionService sessionService) {
    ...
    public void onBrand(long chatId, int messageId, int brandId) throws IOException, InterruptedException {
        ...
        CarOptions options = getCarOptionsService().fetch(brandId);
    ...
    public void onModel(long chatId, int messageId, int modelId) {
        ...
        ModelOption selectedModel = s.carOptions.getModels().stream()
        ...
        getMessages().edit(chatId, messageId, "Choose generation:",
                getKeyboard().generations(selectedModel.getGenerations()));
    }
    ...
    private CarOptionsService getCarOptionsService() {
        return carOptionsService;
    }
